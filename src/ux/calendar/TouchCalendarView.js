 ...
 */
/**
 * @class Ext.ux.calendar.TouchCalendarView
 * @author Stuart Ashworth
 *
 * For use with Sencha Touch 2
 *
 */
Ext.define('Ext.ux.calendar.TouchCalendarView', {
	...
	constructor: function(config){
         ...
         * @param {Ext.ux.calendar.TouchCalendarView} this
	...
	applyViewMode: function(viewMode){
        ...
        var viewModeFns = Ext.ux.calendar.TouchCalendarView[viewMode.toUpperCase()];
	...
	statics: {
		...
		MONTH: {
				...
				getStartDate: function(date){
					return Ext.bind(Ext.ux.calendar.TouchCalendarView.WEEK.getStartDate, this)(new Date(date.getFullYear(), date.getMonth(), 1));
				},
